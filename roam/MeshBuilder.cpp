...
int MeshBuilder::BuildMesh(const char * filename, int size, float amplitude, vector<point4> * vertex_list, vector<point3> * face_list) {

    HeightMap height_vals(filename, amplitude);
